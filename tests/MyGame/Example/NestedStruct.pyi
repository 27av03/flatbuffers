...
class NestedStruct(object):
  ...
  def AAsNumpy(self) -> numpy.ndarray: ...
  ...
  def CAsNumpy(self) -> numpy.ndarray: ...
...
def CreateNestedStruct(builder: flatbuffers.Builder, a: int, b: typing.Literal[TestEnum.A, TestEnum.B, TestEnum.C], c: typing.Literal[TestEnum.A, TestEnum.B, TestEnum.C], d: int) -> int: ...
