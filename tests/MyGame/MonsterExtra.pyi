...
def MonsterExtraAddDvec(builder: flatbuffers.Builder, dvec: int) -> None: ...
def MonsterExtraStartDvecVector(builder: flatbuffers.Builder, num_elems: int) -> int: ...
def StartDvecVector(builder: flatbuffers.Builder, num_elems: int) -> int: ...
def MonsterExtraCreateDvecVector(builder: flatbuffers.Builder, data: typing.Iterable[typing.Any]) -> int: ...
def CreateDvecVector(builder: flatbuffers.Builder, data: typing.Iterable[typing.Any]) -> int: ...
def MonsterExtraAddFvec(builder: flatbuffers.Builder, fvec: int) -> None: ...
def MonsterExtraStartFvecVector(builder: flatbuffers.Builder, num_elems: int) -> int: ...
def StartFvecVector(builder: flatbuffers.Builder, num_elems: int) -> int: ...
def MonsterExtraCreateFvecVector(builder: flatbuffers.Builder, data: typing.Iterable[typing.Any]) -> int: ...
def CreateFvecVector(builder: flatbuffers.Builder, data: typing.Iterable[typing.Any]) -> int: ...
